...
#Go to cart and remove products from cart

cart_button = driver.find_element(By.ID, 'shopping_cart_container')
cart_button.click()
sleep(1)

remove_item_01 = driver.find_element(By.XPATH, '/html/body/div/div/div/div[2]/div/div[1]/div[3]/div[2]/div[2]/button')
remove_item_01.click()
sleep(0.5)
driver.refresh()
...
back_shoping = driver.find_element(By.ID, 'continue-shopping')
back_shoping.click()
